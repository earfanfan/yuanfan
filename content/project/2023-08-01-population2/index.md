...
本小节做因子分析[^7]使用的数据依然是在2019.11.1-2020.10.31的1-79岁人群的死亡率数据。因子分析相当于将1-79岁的16个年龄段死亡率指标转换成了两个不完全独立的因子。当然，解读因子分析结果时，极重要的部分是归纳因子所涵盖的含义，本节忽略这一部分，在绘制各样本的因子得分图时隐藏了中心点向指向各年龄段的箭头。
